...
public class cheapestFlightsWithinKStops {
  ...
  public static void main(String[] args) {
    //There are n cities connected by some number of flights. You are given an array flights where flights[i] = [from,to,price] indicates that there is a flight. You are also given three integers src,dest,and k, return the cheapest price from src to dest with at most k stops. if there is no such route, return -1. all values are positive
    int n = 4;
